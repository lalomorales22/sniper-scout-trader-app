...
const defaultCoins: Record<string, CoinData> = {
  BTC: { symbol: 'BTC', price: 0, priceChange1h: 0, rsi: 50, macdHistogram: 0, macdPrevHistogram: 0, adx: 25, plusDI: 0, minusDI: 0, stochasticK: 50, volumeRatio: 1, timestamp: Date.now() }
};
